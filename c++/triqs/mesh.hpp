...
template <> inline constexpr bool c2py::is_wrapped<triqs::mesh::dlr2d>        = true;
template <> inline constexpr bool c2py::is_wrapped<triqs::mesh::dlr2d_imfreq> = true;
...
template <> inline constexpr char *c2py::tp_name<triqs::mesh::dlr2d>          = "MeshDLR2D";
template <> inline constexpr char *c2py::tp_name<triqs::mesh::dlr2d_imfreq>   = "MeshDLR2DImFreq";
